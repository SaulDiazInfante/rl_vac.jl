...
function get_interval_solution!(time_interval, x_0, policy, action_t, k_0, parameters)
...
@testset "optimize_interval_solution tests" begin
    ...
    opt_solution = optimize_interval_solution(time_interval, x_0, action_t, k_0, parameters)
    ...
    @test_throws BoundsError optimize_interval_solution(time_interval, x_0, action_t, k_0, parameters)
end